# Firmware / Reset / Display Init Prohibition Gate Check

- Generated At UTC: `2026-06-13T16:45:25.066700+00:00`
- Decision: `PASS_FIRMWARE_RESET_DISPLAY_INIT_PROHIBITION_GATE_READY`
...
- Firmware Load Attempted: `False`
- GPU Reset Attempted: `False`
- Framebuffer Init Attempted: `False`
- Display Engine Init Attempted: `False`
- Modeset Attempted: `False`
- Scanout Init Attempted: `False`
...
| --- | --- | --- |
| `contract_file_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/docs/driverkit/firmware-reset-display-init-prohibition-gate.md |
...
| `requires_contract_token_firmware_reset_display_init_prohibition_gate_only_true` | PASS | FIRMWARE_RESET_DISPLAY_INIT_PROHIBITION_GATE_ONLY: True |
...
| `requires_contract_token_modeset_forbidden_true` | PASS | MODESET_FORBIDDEN: True |
| `requires_contract_token_scanout_init_forbidden_true` | PASS | SCANOUT_INIT_FORBIDDEN: True |
...
| `requires_contract_token_firmware_reset_display_init_prohibition_audit_scope` | PASS | FIRMWARE_RESET_DISPLAY_INIT_PROHIBITION_AUDIT_SCOPE |
| `requires_contract_token_firmware_reset_display_init_prohibition_gate_rule` | PASS | FIRMWARE_RESET_DISPLAY_INIT_PROHIBITION_GATE_RULE |
...
| `requires_contract_token_firmware_reset_display_init_prohibition_state_enforced` | PASS | FIRMWARE_RESET_DISPLAY_INIT_PROHIBITION_STATE: ENFORCED |
...
| `requires_contract_token_firmware_load_attempted_false` | PASS | FIRMWARE_LOAD_ATTEMPTED: False |
| `requires_contract_token_gpu_reset_attempted_false` | PASS | GPU_RESET_ATTEMPTED: False |
| `requires_contract_token_framebuffer_init_attempted_false` | PASS | FRAMEBUFFER_INIT_ATTEMPTED: False |
| `requires_contract_token_display_engine_init_attempted_false` | PASS | DISPLAY_ENGINE_INIT_ATTEMPTED: False |
| `requires_contract_token_modeset_attempted_false` | PASS | MODESET_ATTEMPTED: False |
| `requires_contract_token_scanout_init_attempted_false` | PASS | SCANOUT_INIT_ATTEMPTED: False |
...
| `gate_firmware_forbidden` | PASS | firmware load forbidden |
| `gate_reset_forbidden` | PASS | GPU reset forbidden |
| `gate_display_init_forbidden` | PASS | display init forbidden |
...
| `no_forbidden_firmware_markers` | PASS | [] |
| `no_forbidden_reset_markers` | PASS | [] |
| `no_forbidden_display_init_markers` | PASS | [] |
...
| `gpu_gate_driverkit_activation_attempted_false` | PASS | gpu_gate.driverkit_activation_attempted=false |
| `gpu_gate_system_extension_activation_attempted_false` | PASS | gpu_gate.system_extension_activation_attempted=false |
| `gpu_gate_system_extension_deactivation_attempted_false` | PASS | gpu_gate.system_extension_deactivation_attempted=false |
| `gpu_gate_dext_load_attempted_false` | PASS | gpu_gate.dext_load_attempted=false |
| `gpu_gate_device_ownership_request_attempted_false` | PASS | gpu_gate.device_ownership_request_attempted=false |
| `gpu_gate_provider_open_attempted_false` | PASS | gpu_gate.provider_open_attempted=false |
| `gpu_gate_bar_mapping_attempted_false` | PASS | gpu_gate.bar_mapping_attempted=false |
| `gpu_gate_bar_mmio_mutation_attempted_false` | PASS | gpu_gate.bar_mmio_mutation_attempted=false |
| `gpu_gate_real_gpu_command_execution_attempted_false` | PASS | gpu_gate.real_gpu_command_execution_attempted=false |
| `gpu_gate_ui_compositor_proof_claimed_false` | PASS | gpu_gate.ui_compositor_proof_claimed=false |
| `gpu_gate_metal_proof_claimed_false` | PASS | gpu_gate.metal_proof_claimed=false |
...
| `gate_firmware_load_attempted_false` | PASS | firmware_load_attempted=false |
| `gate_gpu_reset_attempted_false` | PASS | gpu_reset_attempted=false |
| `gate_framebuffer_init_attempted_false` | PASS | framebuffer_init_attempted=false |
| `gate_display_engine_init_attempted_false` | PASS | display_engine_init_attempted=false |
| `gate_modeset_attempted_false` | PASS | modeset_attempted=false |
| `gate_scanout_init_attempted_false` | PASS | scanout_init_attempted=false |
