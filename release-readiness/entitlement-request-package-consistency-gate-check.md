# Entitlement Request Package Consistency Gate Check
...
| Check | Status | Detail |
| --- | --- | --- |
| `manifest_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/tools/hackintosh/entitlement-request-package-consistency-gate.json |
| `doc_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/docs/hackintosh/entitlement-request-package-consistency-gate.md |
| `output_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/release-readiness/entitlement-request-package-consistency-gate.json |
| `output_md_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/release-readiness/entitlement-request-package-consistency-gate.md |
...
| `manifest_consistency_gate_only_true` | PASS | consistency_gate_only |
...
| `output_consistency_gate_only_true` | PASS | consistency_gate_only |
...
| `output_input_checklist_pass_true` | PASS | input_checklist_pass |
| `output_input_checklist_check_pass_true` | PASS | input_checklist_check_pass |
...
| `manifest_next_gate` | PASS | next_gate=phase62y-entitlement-request-pre-submission-packet-ledger |
...
| `output_next_gate` | PASS | next_gate=phase62y-entitlement-request-pre-submission-packet-ledger |
| `output_consistency_items_present` | PASS | consistency count |
| `output_consistency_all_pass` | PASS | consistency statuses |
| `doc_contains_This_phase_is_consistency-gate-only` | PASS | This phase is consistency-gate-only |
