# BAR Mapping Prohibition Gate Check

- Generated At UTC: `2026-06-13T16:37:49.676117+00:00`
- Decision: `PASS_BAR_MAPPING_PROHIBITION_GATE_READY`
...
- Memory Descriptor Mapping Forbidden: `True`
- Command Submission Forbidden: `True`
...
| --- | --- | --- |
| `contract_file_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/docs/driverkit/bar-mapping-prohibition-gate.md |
...
| `requires_contract_token_bar_mapping_prohibition_gate_only_true` | PASS | BAR_MAPPING_PROHIBITION_GATE_ONLY: True |
...
| `requires_contract_token_bar_mapping_prohibition_audit_scope` | PASS | BAR_MAPPING_PROHIBITION_AUDIT_SCOPE |
| `requires_contract_token_bar_mapping_prohibition_gate_rule` | PASS | BAR_MAPPING_PROHIBITION_GATE_RULE |
...
| `gate_bar_mapping_forbidden` | PASS | bar mapping forbidden |
| `gate_state_enforced` | PASS | ENFORCED |
| `provider_open_gate_enforced` | PASS | provider open enforced |
...
| `no_forbidden_bar_mapping_markers` | PASS | [] |
| `no_forbidden_mmio_markers` | PASS | [] |
| `no_forbidden_config_write_markers` | PASS | [] |
| `no_forbidden_command_markers` | PASS | [] |
