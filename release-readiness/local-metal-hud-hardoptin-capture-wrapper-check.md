# Local Metal HUD Hard-Opt-In Capture Wrapper Check

- Decision: `PASS_LOCAL_METAL_HUD_HARDOPTIN_CAPTURE_WRAPPER_READY`
...
| Check | Status | Detail |
| --- | --- | --- |
| `manifest_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/tools/hackintosh/local-metal-hud-hardoptin-capture-wrapper.json |
| `doc_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/docs/hackintosh/local-metal-hud-hardoptin-capture-wrapper.md |
| `wrapper_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/scripts/local-metal-hud-hardoptin-capture-wrapper.py |
| `summary_json_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/release-readiness/local-metal-hud-hardoptin-capture-summary.json |
| `summary_md_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/release-readiness/local-metal-hud-hardoptin-capture-summary.md |
| `dryrun_manifest_exists` | PASS | /Users/h1meka/Dev/H1mekaRTX/tools/hackintosh/local-metal-hud-dryrun-launch-command-generator.json |
| `manifest_schema` | PASS | manifest schema |
| `summary_schema` | PASS | summary schema |
| `dryrun_manifest_schema_if_present` | PASS | dryrun manifest schema |
| `manifest_local_metal_hud_hardoptin_capture_wrapper_ready_true` | PASS | local_metal_hud_hardoptin_capture_wrapper_ready |
| `manifest_hardoptin_capture_wrapper_only_true` | PASS | hardoptin_capture_wrapper_only |
...
| `manifest_wrapper_executed_by_ci_false` | PASS | wrapper_executed_by_ci |
| `summary_wrapper_executed_by_ci_false` | PASS | wrapper_executed_by_ci |
...
| `manifest_phase61d_allowed_now_false` | PASS | phase61d_allowed_now |
| `summary_phase61d_allowed_now_false` | PASS | phase61d_allowed_now |
...
| `manifest_next_gate` | PASS | next_gate=phase61d-sanitized-local-metal-hud-capture-summary-parser |
| `wrapper_contains_--i-understand-local-metal-hud-capture` | PASS | --i-understand-local-metal-hud-capture |
| `wrapper_contains_--execute-capture` | PASS | --execute-capture |
| `wrapper_contains_--target-app` | PASS | --target-app |
| `wrapper_contains_--scenario` | PASS | --scenario |
| `wrapper_contains_--duration-seconds` | PASS | --duration-seconds |
| `wrapper_contains_--output-under-host-report-bundle` | PASS | --output-under-host-report-bundle |
| `wrapper_contains_MTL_HUD_ENABLED` | PASS | MTL_HUD_ENABLED |
| `wrapper_contains_MTL_HUD_LOG_ENABLED` | PASS | MTL_HUD_LOG_ENABLED |
| `wrapper_contains_MTL_HUD_LOG_SHADER_ENABLED` | PASS | MTL_HUD_LOG_SHADER_ENABLED |
| `wrapper_contains_REFUSE_LOCAL_METAL_HUD_CAPTURE_HARDOPTIN_NOT_SATISFIED` | PASS | REFUSE_LOCAL_METAL_HUD_CAPTURE_HARDOPTIN_NOT_SATISFIED |
| `wrapper_contains_target_app_sanitized` | PASS | target_app_sanitized |
| `wrapper_contains_<TARGET_APP>` | PASS | <TARGET_APP> |
| `wrapper_contains_provider_open_attempted` | PASS | provider_open_attempted |
| `wrapper_contains_ioserviceopen_attempted` | PASS | ioserviceopen_attempted |
| `wrapper_contains_bar_mapping_attempted` | PASS | bar_mapping_attempted |
| `wrapper_contains_gpu_command_submission_attempted` | PASS | gpu_command_submission_attempted |
...
| `summary_private_paths_committed_recorded` | PASS | private_paths_committed |
...
| `no_raw_stdout_key_in_local-metal-hud-hardoptin-capture-summary.json` | PASS | raw_stdout_key |
| `no_raw_stderr_key_in_local-metal-hud-hardoptin-capture-summary.json` | PASS | raw_stderr_key |
| `no_command_key_in_local-metal-hud-hardoptin-capture-summary.json` | PASS | command_key |
| `no_home_path_in_local-metal-hud-hardoptin-capture-summary.json` | PASS | home_path |
| `no_tmp_path_in_local-metal-hud-hardoptin-capture-summary.json` | PASS | tmp_path |
| `no_email_like_in_local-metal-hud-hardoptin-capture-summary.json` | PASS | email_like |
| `no_raw_stdout_key_in_local-metal-hud-hardoptin-capture-summary.md` | PASS | raw_stdout_key |
| `no_raw_stderr_key_in_local-metal-hud-hardoptin-capture-summary.md` | PASS | raw_stderr_key |
| `no_command_key_in_local-metal-hud-hardoptin-capture-summary.md` | PASS | command_key |
| `no_home_path_in_local-metal-hud-hardoptin-capture-summary.md` | PASS | home_path |
| `no_tmp_path_in_local-metal-hud-hardoptin-capture-summary.md` | PASS | tmp_path |
| `no_email_like_in_local-metal-hud-hardoptin-capture-summary.md` | PASS | email_like |
