...
echo "== H1mekaRTX Phase 11 Deterministic Xcode Project Layout Verification =="
...
echo "== 3. Run deterministic Xcode project layout checker =="
python3 "${ROOT_DIR}/scripts/check-deterministic-xcode-project-layout.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 11 deterministic Xcode project layout verification passed =="
