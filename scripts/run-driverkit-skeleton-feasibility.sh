...
echo "== H1mekaRTX Phase 4 DriverKit Skeleton Feasibility Verification =="
...
echo "== 3. Run DriverKit skeleton feasibility checker =="
python3 "${ROOT_DIR}/scripts/check-driverkit-skeleton-feasibility.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 4 DriverKit skeleton feasibility verification passed =="
