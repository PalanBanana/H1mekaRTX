...
echo "== H1mekaRTX Phase 32 UI Compositor Proof Precondition Schema Verification =="
...
echo "== 3. Run UI compositor proof precondition schema checker =="
python3 "${ROOT_DIR}/scripts/check-ui-compositor-proof-preconditions.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 32 UI compositor proof precondition schema verification passed =="
