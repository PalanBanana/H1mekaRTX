...
echo "== H1mekaRTX Phase 28 BAR Mapping Prohibition Gate Verification =="
...
echo "== 3. Run BAR mapping prohibition gate checker =="
python3 "${ROOT_DIR}/scripts/check-bar-mapping-prohibition-gate.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 28 BAR mapping prohibition gate verification passed =="
