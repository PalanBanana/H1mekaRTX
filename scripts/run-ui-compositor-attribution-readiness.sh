...
echo "== H1mekaRTX Phase 6 UI Compositor Attribution Readiness Verification =="
...
echo "== 3. Run UI compositor attribution readiness checker =="
python3 "${ROOT_DIR}/scripts/check-ui-compositor-attribution-readiness.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 6 UI compositor attribution readiness verification passed =="
