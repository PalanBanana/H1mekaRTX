...
echo "== H1mekaRTX Phase 27 Provider Open Prohibition Gate Verification =="
...
echo "== 3. Run provider open prohibition gate checker =="
python3 "${ROOT_DIR}/scripts/check-provider-open-prohibition-gate.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 27 provider open prohibition gate verification passed =="
