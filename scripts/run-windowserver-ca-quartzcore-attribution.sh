...
echo "== H1mekaRTX Phase 34 WindowServer/CA/QuartzCore Attribution Schema Verification =="
...
echo "== 3. Run WindowServer / CA / QuartzCore attribution schema checker =="
python3 "${ROOT_DIR}/scripts/check-windowserver-ca-quartzcore-attribution.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 34 WindowServer/CA/QuartzCore attribution schema verification passed =="
