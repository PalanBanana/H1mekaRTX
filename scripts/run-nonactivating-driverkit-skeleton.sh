...
echo "== H1mekaRTX Phase 9 Non-Activating DriverKit Skeleton Verification =="
...
echo "== 3. Run non-activating DriverKit skeleton checker =="
python3 "${ROOT_DIR}/scripts/check-nonactivating-driverkit-skeleton.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 9 non-activating DriverKit skeleton verification passed =="
