...
REQUIRED_TERMS = [
    ...
    "generate-ui-compositor-proof-schema.py",
    "collect-ui-compositor-sample.sh",
    "summarize-ui-compositor-sample.py",
    "collect-ui-gpu-attribution.sh",
    "summarize-ui-gpu-attribution.py",
    "generate-ui-workload-correlation-report.py",
    "generate-ui-compositor-readiness-matrix.py",
    "generate-metal-acceleration-entry-gate.py",
