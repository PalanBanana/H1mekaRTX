...
echo "== H1mekaRTX Phase 21 Activation Execution Gate Verification =="
...
echo "== 3. Run activation execution gate checker =="
python3 "${ROOT_DIR}/scripts/check-activation-execution-gate.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 21 activation execution gate verification passed =="
