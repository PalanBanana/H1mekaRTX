...
echo "== H1mekaRTX Phase 20 Activation/Deactivation Dry-Run Skeleton Verification =="
...
echo "== 3. Run activation/deactivation dry-run skeleton checker =="
python3 "${ROOT_DIR}/scripts/check-activation-deactivation-dryrun-skeleton.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 20 activation/deactivation dry-run skeleton verification passed =="
