...
echo "== H1mekaRTX Phase 22 Ledger Override Hard-Block Audit Verification =="
...
echo "== 3. Run ledger override hard-block audit =="
python3 "${ROOT_DIR}/scripts/check-ledger-override-hardblock-audit.py" \
  --root "${ROOT_DIR}" \
  --out-dir "${OUT_DIR}"
...
echo "== Phase 22 ledger override hard-block audit verification passed =="
